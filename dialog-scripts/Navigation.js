...
// Common pattern for navigation intents
const commonPattern = "(I want to|I need to|Will you|Would you|) (go|load|display|open|show|navigate|launch|visit|display the content of|unfold|bring up|present|pull up|spot|locate|get|head over|access|start|enter|view|land|open) (me|) (to|) (a|an|the|)"

// Navigation intents: replace the page names and urls with your own ones
intent(
    `${commonPattern} (home|main|landing|front|initial|starting|start|first|entry) (page|screen|portal|site|section) (please|for me|)`,
...
intent(
    `${commonPattern} (service|services) (section|)`,
...
intent(
     `${commonPattern} portfolio (section|)`,
...
intent(
    `${commonPattern} (contacts|contact) (section|)`,
